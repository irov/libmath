...
namespace mt
{ 
	MENGINE_MATH_METHOD_INLINE mat2f::mat2f()
	{}

	MENGINE_MATH_METHOD_INLINE mat2f::mat2f( float angle )
	{
	...
	MENGINE_MATH_METHOD_INLINE mat2f::mat2f(const mat2f& _rhs)
		:v0(_rhs.v0)
		,v1(_rhs.v1)
	{}

	MENGINE_MATH_METHOD_INLINE mat2f::mat2f(const vec2f& _v0, const vec2f& _v1)
		:v0(_v0)
		,v1(_v1)
	{}

	MENGINE_MATH_METHOD_INLINE vec2f& mat2f::operator [](size_t i)
	{
		return (&v0)[i];
	}

	MENGINE_MATH_METHOD_INLINE const vec2f& mat2f::operator [](size_t i)const
	{
		return (&v0)[i];
	}

	MENGINE_MATH_METHOD_INLINE mat2f& mat2f::operator=(const mat2f& _rhs)
	{
		v0 = _rhs.v0;
		v1 = _rhs.v1;
		return *this;
	...
	MENGINE_MATH_METHOD_INLINE bool cmp_m2_m2(const mat2f& _a, const mat2f& _b)
	{ 
		return cmp_v2_v2(_a.v0,_b.v0) &&
			cmp_v2_v2(_a.v1,_b.v1);
	}

	MENGINE_MATH_METHOD_INLINE bool operator==(const mat2f& _a, const mat2f& _b)
	{
	...
	MENGINE_MATH_FUNCTION_INLINE vec2f operator*(const mat2f& m, const vec2f& v)
	{
		vec2f out;
		mul_m2_v2(out,m,v);
		return out;
