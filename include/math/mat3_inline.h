...
namespace	mt
{ 
	MENGINE_MATH_METHOD_INLINE mat3f::mat3f()
	{}

	MENGINE_MATH_METHOD_INLINE mat3f::mat3f(const mat3f&	_rhs)
	: v0(_rhs.v0)
	, v1(_rhs.v1)
	, v2(_rhs.v2)
	{
	...
	MENGINE_MATH_METHOD_INLINE vec3f& mat3f::operator [](size_t i)
	{
		return (&v0)[i];
	}

	MENGINE_MATH_METHOD_INLINE const vec3f& mat3f::operator [](size_t i)const
	{
		return (&v0)[i];
	}

	MENGINE_MATH_METHOD_INLINE mat3f& mat3f::operator=(const mat3f& _rhs)
	{
		v0 = _rhs.v0;
		v1 = _rhs.v1;
		v2 = _rhs.v2;
	...
	MENGINE_MATH_METHOD_INLINE float * mat3f::buff()
	{
		return v0.buff();
	}
	...
	MENGINE_MATH_FUNCTION_INLINE vec3f operator*(const mat3f& m, const vec3f& v)
	{
		vec3f out;
		mul_m3_v3(out,m,v);
		return out;
	...
	MENGINE_MATH_FUNCTION_INLINE void mul_m3_m3_i( vec3f & _out, const vec3f & _a, const mat3f& _b )
	{
	...
	/*	Identity	matrix	*/
	MENGINE_MATH_FUNCTION_INLINE void ident_m3(mat3f& _out)
	{
		ident_v3( _out.v0 );
		ident_v3( _out.v1 );
		ident_v3( _out.v2 );
