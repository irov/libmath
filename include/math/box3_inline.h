namespace mt
{
	MENGINE_MATH_METHOD_INLINE box3f::box3f()
	{}

	MENGINE_MATH_METHOD_INLINE box3f::box3f(const box3f & _box)
		:	min(_box.min)
		,	max(_box.max)
	{}


	MENGINE_MATH_METHOD_INLINE box3f::box3f(const vec3f &_min,const vec3f &_max)
		:	min(_min)
		,	max(_max)
	{}
	...
	MENGINE_MATH_FUNCTION_INLINE void GetUVHVector(vec3f uvh[3],const box3f &box)
	{
