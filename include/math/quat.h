...
namespace mt
{
	...
	MT_FUNCTION_INLINE quatf operator-(const quatf& _a, const quatf& _b);
	MT_FUNCTION_INLINE quatf operator*(const quatf& _a, const quatf& _b);
	MT_FUNCTION_INLINE vec3f operator*(const quatf& _rhs, const vec3f& _v);
	MT_FUNCTION_INLINE quatf operator*(const quatf& _rhs, float _val);
	MT_FUNCTION_INLINE quatf operator/(const quatf& _rhs, float _val);
	...
	MT_FUNCTION_INLINE void mul_q_q(quatf& out, const quatf& _rhs, const quatf& in2);
	MT_FUNCTION_INLINE void mul_q_v3(vec3f& out,const quatf& _rhs,const vec3f& in2);
	MT_FUNCTION_INLINE void scale_q_s(quatf& out, const quatf& _rhs, float _val);
