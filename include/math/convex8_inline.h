...
namespace mt
{
    ...
    //////////////////////////////////////////////////////////////////////////
    LIBMATH_METHOD_INLINE const mt::vec2f & convex8::operator [] ( size_t i ) const
    {
        return this->point[i];
    }
    //////////////////////////////////////////////////////////////////////////
    LIBMATH_METHOD_INLINE mt::vec2f & convex8::operator [] ( size_t i )
    {
        return this->point[i];
    }
    //////////////////////////////////////////////////////////////////////////
    LIBMATH_METHOD_INLINE void convex8::add( const mt::vec2f & v )
    {
        this->point[this->count++] = v;
    }
    //////////////////////////////////////////////////////////////////////////
    LIBMATH_METHOD_INLINE const mt::vec2f & convex8::front() const
    {
        return this->point[0];
    }
    //////////////////////////////////////////////////////////////////////////
    LIBMATH_METHOD_INLINE const mt::vec2f & convex8::back() const
    {
        return this->point[this->count - 1];
    }
    //////////////////////////////////////////////////////////////////////////
    LIBMATH_METHOD_INLINE uint32_t convex8::size() const
    {
        return this->count;
    }
    //////////////////////////////////////////////////////////////////////////
    LIBMATH_METHOD_INLINE bool convex8::empty() const
    {
        return this->count == 0U;
    }
    //////////////////////////////////////////////////////////////////////////
    LIBMATH_METHOD_INLINE void convex8::clear()
    {
        this->count = 0U;
    }
    //////////////////////////////////////////////////////////////////////////
