...
namespace mt
{
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE int32_t convex8_line_sect( const vec2f & x0, const vec2f & x1, const vec2f & y0, const vec2f & y1, vec2f & res )
    {
        vec2f dx = x1 - x0;
        vec2f dy = y1 - y0;
        vec2f d = x0 - y0;
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE int convex8_left_of( const vec2f & a, const vec2f & b, const vec2f & c )
    {
        vec2f tmp1 = b - a;
        vec2f tmp2 = c - b;
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE void convex8_poly_edge_clip( const mt::convex8 & sub, const vec2f & x0, const vec2f & x1, int left, mt::convex8 & res )
    {
        res.clear();
