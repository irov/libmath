...
namespace mt
{
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE vec3f::vec3f( const mt::vec3f & _v )
        : x( _v.x )
        , y( _v.y )
        , z( _v.z )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE vec3f::vec3f( const mt::vec2f & _v, float _z )
        : x( _v.x )
        , y( _v.y )
        , z( _z )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE mt::vec3f & vec3f::operator=( const mt::vec3f & _rhs )
    {
        this->x = _rhs.x;
        this->y = _rhs.y;
        this->z = _rhs.z;
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE mt::vec3f & vec3f::operator /= ( const float _rhs )
    {
        operator *= ( 1.f / _rhs );
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE mt::vec2f vec3f::to_vec2f() const
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE const mt::vec3f & vec3f::identity()
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE void reflect_v3_v3( mt::vec3f * const _out, const mt::vec3f & _a, const mt::vec3f & _b )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE float project_to_line_v3_v3( mt::vec3f * const _out, const mt::vec3f & _a, const mt::vec3f & _b, const mt::vec3f & _c )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE void cross_v3_v3_norm( mt::vec3f * const _out, const mt::vec3f & _a, const mt::vec3f & _b )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE void norm_safe_v3( mt::vec3f * const _out, const mt::vec3f & _rhs, float _err )
    {
