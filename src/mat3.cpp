...
{
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE mat3f::mat3f()
    {
    }
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE mat3f::mat3f( const mt::mat3f & _rhs )
        : v0( _rhs.v0 )
        , v1( _rhs.v1 )
        , v2( _rhs.v2 )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE mat3f::mat3f( const mt::vec3f & _v0, const mt::vec3f & _v1, const mt::vec3f & _v2 )
        : v0( _v0 )
        , v1( _v1 )
        , v2( _v2 )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE mat3f::mat3f( float _v00, float _v01, float _v02, float _v10, float _v11, float _v12, float _v20, float _v21, float _v22 )
        : v0( _v00, _v01, _v02 )
        , v1( _v10, _v11, _v12 )
        , v2( _v20, _v21, _v22 )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE mt::vec3f & mat3f::operator []( size_t i )
    {
        return (&v0)[i];
    }
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE const mt::vec3f & mat3f::operator []( size_t i )const
    {
        return (&v0)[i];
    }
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE mt::mat3f & mat3f::operator=( const mt::mat3f & _rhs )
    {
        v0 = _rhs.v0;
        v1 = _rhs.v1;
        v2 = _rhs.v2;
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_METHOD_INLINE float * mat3f::buff()
    {
        return v0.buff();
    }
    //////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE void mul_m3_m3_i( mt::vec3f * const _out, const mt::vec3f & _a, const mt::mat3f & _b )
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE mat3f operator* ( const mt::mat3f & _a, const mt::mat3f & _b )
    {
        mt::mat3f out;
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE mat3f operator*( const mt::mat3f & _rhs, float _val )
    {
        mt::mat3f out;
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE mat3f transpose_m3( const mt::mat3f & _rhs )
    {
        mt::mat3f out;
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE vec3f get_col_m3( const mt::mat3f & _rhs, int _index )
    {
        mt::vec3f out;
    ...
    //////////////////////////////////////////////////////////////////////////
    MT_FUNCTION_INLINE mat3f set_m3_from_axes( const mt::vec3f & _a, const mt::vec3f & _b, const mt::vec3f & _c )
    {
        mt::mat3f m;
